...
SECRET_KEY = 'django-insecure-w0h9m$ja-)qufh$44m20h3vbxk8)#_pja8p-99mtbgle(dt#ur'
...
ROOT_URLCONF = 'pharmascheduler.urls'
...
WSGI_APPLICATION = 'pharmascheduler.wsgi.application'
